    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="general-pagess">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/view-transactions' ?>"> Completed Transactions </a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/view-pending-transactions'?>"> Pending Transactions </a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/not-approved-shares' ?>"> Pending Approval </a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/rejected-shares' ?>"> Rejected Shares </a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="audit_trail">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/audit_trail' ?>"> System Errors </a></li>
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/user-log-in-activities' ?>"> User's Login Activities </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Sacco's Login Activities </a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="settings">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url().'/supperAdmin/not-approved-shares' ?>"> Cookies Settings </a></li>
                </ul>
            </div>
        </li>
