    ...
    <div class="container">
        <div class="borders mb-4">
                ...
                <div class="phone-details">
                    ...
                    <div class="phone-input">
                            <div class="phone-details-sm">
                                ...
                                <input type="number" id="phone" pattern="^7\d{8}$" name="phone" value="<?= $phone ?>">
                                <input type="hidden" id="share_id" pattern="^7\d{8}$" name="phone" value="<?= $share_id ?>">
                            </div>
            ...
            <div class="footer-button">
                ...
                <button type="button" class="footer-pay-button" id="displayPaymentModal" disabled><span><i class="fa-solid fa-lock"></i></span> Confirm Payment
                </button>
            </div>
        </div>
    </div>
...
<div id="id04" class="user-share-model">
    <div class="modal-content-user animate">
        ...
        <div class="container1">
            <div class="confirm-bidding">
                ...
                <label for="shares"><b class="shares-sell-heading text-warning">
                        <i class="fas fa-circle-exclamation"
                           style="padding-right: 5px;"></i>Please confirm that you want to pay ksh: <?= $total ?> to saccoHisa</b></label>
            ...
            <div class="text-center">
                <button class="footer-link" id="pay-now">Pay Now</button>
            </div>
        </div>
    </div>
</div>
...
<?= $this->endSection(); ?>
<?php $this->section('payment-script'); ?>
<script>
    $(document).ready(function(){
        ...
        checkBox.on('change', function(){
            if($(this).is(':checked')){
                ...
                $('#displayPaymentModal').prop('disabled', false);
                $('#displayPaymentModal').addClass('enabled');
            }else{
                $(this).removeClass('paycheck');
                $('#displayPaymentModal').prop('disabled', true);
                $('#displayPaymentModal').removeClass('enabled');
            }
        })
        ...
        $('#pay-now').on('click', function(){
            let combinedPhoneNumber = phoneCode + phoneNumber;
            ...
            $.ajax({
                url: '<?= base_url() . '/payment/client/payment' ?>',
                method: 'POST',
                data: {
